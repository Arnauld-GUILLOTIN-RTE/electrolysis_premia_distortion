...
- Antares simulation folders, at the root of `data/simulations/` (download from associated Zenodo record). The structure of the folder should be, for a given simulation, e.g., `data/simulations/NT2040_0/`
